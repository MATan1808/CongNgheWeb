                    ...
                    <div class="rectangle-frame">
                        <div class="generation-grid">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<button class="btn btn-primary view-more-button" onclick="redirectToTaodoi(\'' . $row['name_member'] . '\')">Xem thêm</button>';
...
function deleteGeneration(generationName) {
    ...
    // lam su kien nut xem them
    function redirectToTaodoi(generation) {
    // Tạo đường link đến trang taodoi.php với tham số 'generation' được truyền vào
    var url = 'taodoi.php?generation=' + generation;
    // Chuyển hướng người dùng đến trang taodoi.php
